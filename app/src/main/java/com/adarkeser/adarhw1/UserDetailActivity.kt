...
import com.adarkeser.adarhw1.databinding.ActivityUserDetailBinding
...
class UserDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.descriptionView.text = userAddress
        binding.funfactView.text = "Fun Fact! $userProfile"
